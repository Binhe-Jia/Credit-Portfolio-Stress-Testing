...
The app includes sample CSV files:

- `sample_portfolio.csv`: small baseline sample
- `stress_test_portfolio_25.csv`: larger diversified portfolio
- `high_pd_small_company_stress_portfolio_35.csv`: higher-risk stress-test portfolio

If Yahoo Finance does not return price history for a ticker, the app can drop unavailable tickers and continue when the sidebar option is enabled.
